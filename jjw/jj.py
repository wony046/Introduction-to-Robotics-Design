...
SAFETY_MARGIN    = 40    # mm: 수평 안전 여유 → threshold = 120mm (수정) 10 > 40
...
SLOW_START_DIST  = 450  # mm: 이 전방거리부터 감속 시작 250 450 미리 감속
STOP_FWD_RANGE   = 200   # mm: v=0 구역 전방 깊이 125 200 여유 있게 정지 
W_GAIN           = 1.2
MAX_W            = 1.5
...
# ── 측면 감지 (수직/수평 거리 기반) ──────────────────────────────────────────
SIDE_HORIZ_LIMIT  = 160  # mm: 측면 수평거리 임계값 (이 미만이면 측면 차단) 130 >160
